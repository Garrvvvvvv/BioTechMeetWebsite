            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.25 }}>
              ...
              <Box sx={{ lineHeight: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                  ...
                  {/* When user is signed in show small logout + logs icons */}
                  {user && (
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                      <Tooltip title="Logout">
                        <IconButton
                          size="small"
                          onClick={() => {
                              // record logout and clear auth
                              localStorage.removeItem('app_auth');
                            setUser(null);
                            // ensure any other listeners pick up change
                            window.dispatchEvent(new StorageEvent('storage', { key: 'app_auth', newValue: null }));
                          }}
